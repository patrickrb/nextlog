...
-- SSTV images functionality
-- This adds tables to store SSTV images decoded from radio audio
...
\echo 'SSTV images and radio configuration tables created successfully!'
